...
export class Sidebar {
  ...
  navItems: NavItem[] = [
    ...
    { label: 'Teams', path: '/teams', icon: 'M12 7a3 3 0 1 0 0 6 3 3 0 0 0 0-6zm0-4a7 7 0 0 0-7 7 7 7 0 0 0 7 7 7 7 0 0 0 7-7 7 7 0 0 0-7-7zm0 12a5 5 0 0 1-5-5h10a5 5 0 0 1-5 5z' },
